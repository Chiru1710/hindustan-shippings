    ...
    <div className="py-10 sm:py-14">
      ...
      <section className="grid items-start gap-8 lg:grid-cols-2">
        <div>
          ...
          <p className="mb-6 text-sm leading-relaxed text-neutral-200 sm:text-base">
            Hindustan Shipping Agency is a GST-registered shipping and customs
            clearance agency based at Jaigad (Jaigarh) Port in Ratnagiri,
            Maharashtra. We provide end-to-end support for exporters, importers,
            traders and logistics partners using ports along the Maharashtra
            coastline.
          </p>
        ...
        <div>
          <div className="p-5 rounded-2xl bg-neutral-950/40 border border-neutral-800">
            ...
            <ul className="mb-5 space-y-2 text-sm text-neutral-200">
              <li>• Vessel &amp; shipping agency services at Jaigad Port.</li>
              <li>• Customs &amp; documentation support via authorised partners.</li>
              <li>
                • Coordination with port, customs, surveyors &amp; transporters.
              </li>
      ...
      <section className="pt-10 mt-10 border-t border-neutral-800">
        ...
        <p className="max-w-2xl mb-5 text-sm text-neutral-200">
          ...
          Hindustan Shipping Agency can handle vessel and cargo operations at
          Jaigad (Jaigarh) and other notified minor ports along the Maharashtra
          coastline, subject to applicable permissions.
        </p>
        <div className="grid gap-4 text-sm sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="p-4 rounded-xl bg-neutral-950/40 border border-neutral-800">
            ...
            <div className="text-xs text-neutral-200">
              Coordination at other notified minor ports under customs
          ...
          <div className="p-4 rounded-xl bg-neutral-950/40 border border-neutral-800">
            ...
            <div className="text-xs text-neutral-200">
              Support for truck movements &amp; connectivity to nearby industrial
              and agro clusters.
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-4 text-sm sm:grid-cols-3">
          <div className="p-4 rounded-xl bg-neutral-950/40 border border-neutral-800">
            ...
            <p className="text-xs text-neutral-200">
              Ground experience with Jaigad Port operations, customs procedures
          ...
          <div className="p-4 rounded-xl bg-neutral-950/40 border border-neutral-800">
            ...
            <p className="text-xs text-neutral-200">
              One point of contact for documentation, vessel coordination and
              transport alignment.
            </p>
          </div>
          <div className="p-4 rounded-xl bg-neutral-950/40 border border-neutral-800">
            ...
            <p className="text-xs text-neutral-200">
              Clear communication, transparent costing and timely updates at
              every stage.
            </p>
          </div>
        </div>
