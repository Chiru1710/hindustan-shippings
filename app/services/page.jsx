...
export default function ServicesPage() {
    return (
        <div className="py-10 sm:py-14">
            <h1 className="mb-3 text-2xl font-semibold sm:text-3xl">Services We Provide</h1>
            <p className="max-w-2xl mb-6 text-sm text-neutral-200">
                Hindustan Shipping Agency offers end-to-end port-side and documentation support for exporters,
                importers and vessel operators using Jaigad (Jaigarh) Port and nearby coastal locations in
                Maharashtra.
            </p>
            ...
            <div className="grid gap-5 md:grid-cols-2">
                {services.map((service) => (
                    ...
                    >
                        ...
                        <p className="mb-3 text-xs text-neutral-200">{service.description}</p>
            ...
            <div className="p-5 mt-8 text-sm text-neutral-200 rounded-xl bg-neutral-950/60 border border-neutral-800">
                ...
                <p className="mb-3 text-sm text-neutral-200">
                    Every shipment and port call has its own operational requirements. If you need support beyond
                    the services listed above, we can discuss a customised handling plan based on your commodity,
                    volume and schedule.
                </p>
